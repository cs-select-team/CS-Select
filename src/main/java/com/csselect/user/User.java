...
public abstract class User{
    ...
    /**
     * Constructor for an User object. Aatabase adapter is set to allow communication with our database
     * (object of {@link UserAdapter}. The constructor will be called as soon as a user registers and logs in
     * or out. Which value the unique ID will have (registration) is determined
